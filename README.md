...
- Puzzle 14: See `wip/14` for attempt on solving part 2. Have tried using various ways to "calculate" if the positions might resemble a christmas tree (e.g. limited amount of points in the upper corners). But no luck...
